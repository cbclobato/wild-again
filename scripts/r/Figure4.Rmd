...
```{r, echo = FALSE}
pouches1 <- read.table(
  "data/metadata/pouches1-ext.tsv",
  sep = "\t",
  header = TRUE,
  fill = TRUE,
  row.names = "ID")
...
pouches2 <- read.table(
  "data/metadata/pouches2-ext.tsv",
  sep = "\t",
  header = TRUE,
  fill = TRUE,
  row.names = "ID")
...
shapiro.test(pouches1[pouches1$germination == TRUE, x]) 
...
plab2 <- ggplot(data = dflab2, 
  ...
  labs(x = "", y = "Length [cm]", fill = "") # Add pairwise comparisons p-value
plab2

# ggsave("outputs/visual/fig_4/length-ext.png",
#         width = 20,
#         height = 18,
#         units = "cm",
#         scale = 1,
...
# ggsave("outputs/visual/fig_4/biomass-ext.png",
#         width = 20,
#         height = 18,
#         units = "cm",
#         scale = 1,
...
png("outputs/visual/fig_4/lab-bar.png",
    bg = "white",
    width = 23,
    height = 16,
    units = "cm",
    res = 600); print(p_lab); dev.off()

save(p_lab,
     file = "outputs/r/fig_4/field-line_AB.RData")
...
#### Chi-sqr: The proportion of "parameter x" differs between treatments.
...
ggsave("outputs/visual/fig_4/traits-ext-per.png", #stack
        width = 20,
        height = 18,
        units = "cm",
        scale = 1,
...
## Physiological assays: Add table on Supp
...
pwies1 <- ggplot(data = dfwies1, 
  ...
  geom_text(aes(x = 3,
            ...
            color = "black",
            size = 5)
# pwies1$layers[1] <- NULL # don't use with cowplot
pwies1

# ggsave("outputs/visual/fig_4/weight-boxplot.png",
#         width = 20,
#         height = 18,
#         units = "cm",
#         scale = 1,
...
pwies2
pwies2$layers[1] <- NULL

# ggsave("outputs/visual/fig_4/height-boxplot.png",
#         width = 20,
#         height = 18,
#         units = "cm",
#         scale = 1,
...
pwies3 <- ggplot(data = dfwies3, 
  ...
  theme(
    ...
    legend.text = element_text(size = 12)) +
  scale_color_manual(values = my_colors) +
  labs(x = "Timepoint", y = "Stalk diameter (cm)", color = "Treatment"); pwies3
pwies3$layers[1] <- NULL

# ggsave("outputs/visual/fig_4/stalk-boxplot.png",
#         width = 20,
#         height = 18,
#         units = "cm",
#         scale = 1,
...
# ggsave("outputs/visual/fig_4/height-lineplot.png",
#         width = 20,
#         height = 18,
#         units = "cm",
#         scale = 1,
...
# ggsave("outputs/visual/fig_4/stalk-lineplot.png",
#         width = 20,
#         height = 18,
#         units = "cm",
#         scale = 1,
...
# png("outputs/visual/fig_4/field-line-AB.png",
#     bg = "white",
#     width = 20,
#     height = 18,
#     units = "cm",
#     res = 600); print(p_AB); dev.off()
# 
# save(p_AB,
#      file = "outputs/r/fig_4/field-line_AB.RData")
...
png("outputs/visual/fig_4/field-line-CD.png",
    bg = "white",
    width = 20,
    height = 18,
    units = "cm",
    res = 600); print(p_CD); dev.off()

# save(p_CD,
#      file = "outputs/r/fig_4/field-line.RData")
...
# png("outputs/visual/fig_4/field-line2.png",
#     bg = "white",
#     width = 45,
#     height = 31,
#     units = "cm",
#     res = 600); print(p_field); dev.off()
# 
# save(p_field,
#      file = "outputs/r/fig_4/field-line.RData")
