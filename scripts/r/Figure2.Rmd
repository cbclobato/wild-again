...
# test significance
vegan::adonis2(bh_css_bray ~ chemotype2,
               data = df_css)
...
ggsave("outputs/visual/fig_2/sig-pwa-chem.png",
       width = 23,
       height = 16,
       units = "cm",
       dpi = 600)
...
# Stress indicates the "goodness of fit” of your NMDS ordination. 
# For a good representation of your data, the stress value should be less than 0.2. 
# If the stress value is 0, it might mean you have an outlier sample.
# Lower stress values indicate greater conformity and therefore are desirable.
# bh_NMDS <- ordinate(bh_css, "NMDS", "bray", trymax = 1000); bh_NMDS
# save(bh_NMDS, file = "outputs/r/fig_2/bh-nmds.RData")
# Stress:     0.188289 
# Stress type 1, weak ties
load("outputs/r/fig_2/bh-nmds.RData") # bh_NMDS

mycolors <- c("#6159a4","#feae01","#0ea5e9","#ff6682") 
column1 <- sample_data(bh_css)$domestication
# column2 <- sample_data(bh_css)$chemotype
# column3 <- sample_data(bh_css)$genotype

nmds <- plot_ordination(bh_css, bh_NMDS) +
  geom_point(
...
# ggsave(
#   "outputs/visual/fig_2/nmds-bray-dom.png",
#   width = 20,
#   height = 18,
#   units = "cm",
#   scale = 1,
...
load("outputs/r/fig_2/UMAP.RData") #df_postproc
...
# ggsave("outputs/visual/fig_2/silhouette.png",
#         width = 40,
#         height = 20,
#         units = "cm",
#         scale = 1,
...
p1 <-
  ...
  scale_shape_manual(values = c(1, 19, 4)) + # 13
...
# ggsave("outputs/visual/fig_2/umap-dom.png",
#         width = 45,
#         height = 31,
#         units = "cm",
#         scale = 1,
...
save(p1,
     file = "outputs/r/fig_2/umap.RData")
```
...
# ggsave("outputs/visual/fig_2/heattree-relab-asv-DHKK.png",
#        bg = "white",
#        width = 30,
#        height = 30,
#        units = "cm",
...
```{r, out.width = "25%"}
ht2 <- grid::rasterGrob(png::readPNG("outputs/visual/fig_2/heattree-relab-asv-DHKKmod.png"), 
                       interpolate = T)
...
# ggsave("outputs/visual/fig_2/dom-genus-class-0.05.png",
#        width = 80,
#        height = 40,
#        units = "cm",
#        dpi = 600)
...
load("outputs/r/fig_2/umap.RData") # p1
load("outputs/r/fig_2/barplot.RData") # bp_g1

fig2 <- cowplot::plot_grid(ht2,
                           p1, 
                           labels = c("a", "b"),
                           nrow = 1,
                           rel_widths = c(1.15, 1),
...
# ggsave("outputs/visual/fig_2/p2-final.png",
# bg = "white",
# width = 45,
# height = 31,
# units = "cm",
...
# ggsave("outputs/visual/fig_2/genus-0.05-gen-grid.png",
#        width = 45,
#        height = 31,
#        units = "cm",
#        dpi = 600)
