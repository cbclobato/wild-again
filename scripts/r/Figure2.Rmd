...
p1 <-
  ...
  theme(
    ...
    legend.position = c(0.145, 0.84),
    legend.background = element_rect(fill = "transparent", 
                                     color = "transparent"),
    legend.box = "horizontal") +
  annotation_custom(ggplotGrob(p0),
                    xmin = 11.75, xmax = 14.75,
                    ymin = -4.5, ymax = -1.25); p1
...
bp_g1 <- plot_composition_v2(bh_agr,
  ...
  scale_fill_manual(values = color,
                    labels = substring(as.factor(otu_order), 1, 16)) +
...
Fig2 <- cowplot::plot_grid(Fig2AB,
  ...
  geom_text(aes(x = c(0.165, 0.345, 0.51, 0.672, 0.87),
                y = rep(0.37, 5)),
            label = c("LANDRACES", "SELECTED LINES", "CROSS HYBRIDS", "INBRED LINES", "NA"),
            size = 3,
            angle = 0) +
   geom_text(aes(x = c(0.27, 0.291, 0.376, 0.568, 0.59, 0.61, 0.762, 0.95, 0.973),
                 y = rep(0.1, 9)),
            label = "*",
            size = 5,
            fontface = "bold"); Fig2
