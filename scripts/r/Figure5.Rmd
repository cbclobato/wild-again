...
Fig5 <- ggplot(data, 
  ...
  geom_segment(data = grid_data, aes(x = end, y = 2,
               ...
               colour = "#a6a6a6", alpha = 0.6, size = 0.3, inherit.aes = F) +
  # Top segments
  geom_segment(data = grid_data, aes(x = 45, y = 1108,
                                     xend = 47, yend = 1108), 
               colour = "#a6a6a6", alpha = 0.6, size = 0.3, inherit.aes = F) +
  geom_segment(data = grid_data, aes(x = 45, y = 200,
                                     xend = 47, yend = 200), 
               colour = "#a6a6a6", alpha = 0.6, size = 0.3, inherit.aes = F) +
  geom_segment(data = grid_data, aes(x = 45, y = 80,
                                     xend = 47, yend = 80), 
               colour = "#a6a6a6", alpha = 0.6, size = 0.3, inherit.aes = F) +
  geom_segment(data = grid_data, aes(x = 45, y = 30,
                                     xend = 47, yend = 30), 
               colour = "#a6a6a6", alpha = 0.6, size = 0.3, inherit.aes = F) +
  geom_segment(data = grid_data, aes(x = 45, y = 2,
                                     xend = 47, yend = 2), 
               colour = "#a6a6a6", alpha = 0.6, size = 0.3, inherit.aes = F) +
  # Top labels
  annotate("label", 
